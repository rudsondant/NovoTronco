...
<form role="form" method="post" action="listar_coletanea.php" enctype="multipart/form-data">
 ...
 <?php
 	if((!isset( $_POST['pesquisar']))||(empty($_POST['pesquisar']))){
		...
		echo "<th class='text-center'> Peças</th>";
		...
		while($listar_coletanea = mysql_fetch_array($coletanea)) {
			...
			echo "   ";
						  echo"<a href='cadastrar/excluir_coletanea.php?id={$listar_coletanea['id']}' onclick='return confirmar();'  class='fa fa-trash fa-lg fa-danger' style='color:red'></a>";
			echo"</td>";
			echo "</tr>";
		}
		...
		echo "<tfoot>";
		echo"<tr>";
		echo "<td class='text-center'><a href='cadastrar_coletanea.php'><i class='fa fa-plus-square'></a></td><td></td><td></td><td></td><td></td>";
		...
		echo "<tr><td class='text-center> Não há Colentaneas cadastradas</td></tr>";
		echo "<tr><td class='text-center><a href='cadastrar_coletanea.php'><i class='fa fa-plus-square'></a></td></tr>";
		echo "</table>";
		}
	}else{
	/*Pesquisa*/
	$pesquisa=$_POST['pesquisar'];
		$coletanea = mysql_query("Select c.id id ,c.titulo titulo ,c.descricao descricao from coletanea c where c.titulo like '%".$pesquisa."%' ");
		if((mysql_num_rows($usuario))!=0){
		echo "<table id='tabela' class='table table-striped  sortable'>";
		echo "<thead>";
		echo"<tr>";
		...
		echo "<table class='table table-hover'>";
		echo "<tr><td class='text-center> Nenhuma Coletanea encontrada</td></tr>";
		echo "<tr><td class='text-center><a href='cadastrar_coletanea.php'><i class='fa fa-plus-square'></a></td></tr>";
		echo "</table>";
		}
